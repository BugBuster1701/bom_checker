 ...
 * Back end module
 */
$GLOBALS['TL_LANG']['BomChecker']['title']          = 'Byte Order Mark (BOM) - Checker';
$GLOBALS['TL_LANG']['BomChecker']['modules']	    = 'Aktive Module';
$GLOBALS['TL_LANG']['BomChecker']['directories']    = 'Spezielle Verzeichnisse';
